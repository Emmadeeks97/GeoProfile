...
## 02/04/26
- Add gplv3 license (in discussion with ED)
...
- Replace all @examples directives with `@examplesIf interactive()` to prevent examples from bogging down the R CMD CHECK system.
- Add R_ignore and TODO.md to .Rbuildignore (so they don't interfere with the build procedure).
- Second R CMD CHECK

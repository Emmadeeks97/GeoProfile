# RgeoEmma: Dirichlet Process Mixture (DPM) model of geographic profiling

Carries out a DPM mixture model of geographic profiling (and associated
functions) as described in Verity et al. (2014) For links to papers see
http:/www.sbcs.qmul.ac.uk/staff/stevenlecomber.html or contact Steven Le
Comber (s.c.lecomber@qmul.ac.uk). Created and maintained by Bob Verity
(r.verity@imperial.ac.uk).

## Details

RgeoProfile: Dirichlet Process Mixture (DPM) model of geographic
profiling
...
([ORCID](https://orcid.org/0000-0003-2552-7848)) \[copyright holder\]
...
- Francis Windram <francis.windram17@imperial.ac.uk>
  ([ORCID](https://orcid.org/0000-0002-2129-826X))
